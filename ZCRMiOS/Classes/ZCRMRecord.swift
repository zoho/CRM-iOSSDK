...
public class ZCRMRecord : ZCRMEntity
{
    ...
    public func convert( completion : @escaping( [ String : Any ]?, APIResponse?, Error? ) -> () )
    {
        ...
        {
            self.convert(newPotential: nil, assignTo: nil) { ( convertedRecordDict, APIResponse, error ) in
