...
open class ZCRMTag : ZCRMEntity
{
    ...
    public func update( completion : @escaping ( CRMResultType.DataResponse< ZCRMTag, APIResponse > ) -> () )
    {
    ...
    public func getRecordCount( completion : @escaping ( CRMResultType.DataResponse< Int64, APIResponse > ) -> () )
    {
    ...
    public func merge( withTag : ZCRMTag, completion : @escaping ( CRMResultType.DataResponse< ZCRMTag, APIResponse > ) -> () )
    {
