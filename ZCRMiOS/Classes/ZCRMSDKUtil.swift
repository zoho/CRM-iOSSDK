...
public class ZCRMSDKUtil: ZCacheClient
{
    ...
    public func getModuleFromServer<T>(id: String, completion: @escaping ((ResultType.Data<T>) -> Void))
    {
    ...
    public func getModuleFromServer<T>(withName: String, completion: @escaping ((ResultType.Data<T>) -> Void))
    {
        MetaDataAPIHandler().getModule(apiName: withName)
        {
            ...
            case .success(let module, _):
                do
                {
                    completion(.success(data: module as! T))
                }
            case .failure(let error):
                do
                {
    ...
    public func getUserFromServer<T>(id: String, completion: @escaping ((ResultType.Data<T>) -> Void))
    {
        UserAPIHandler(cacheFlavour: .noCache).getUser(userId: id)
        {
            ...
            case .success(let user, _):
                do
                {
                    completion(.success(data: user as! T))
                }
            case .failure(let error):
                do
                {
    ...
    public func getCurrentUserFromServer<T>(completion: @escaping ((ResultType.Data<T>) -> Void))
    {
    ...
    public static func getOrgDetails( completion : @escaping( CRMResultType.DataResponse< ZCRMOrg, APIResponse > ) -> () )
    {
    ...
    public static func getOrgDetailsFromServer( completion : @escaping( CRMResultType.DataResponse< ZCRMOrg, APIResponse > ) -> () )
    {
    ...
    public static func getOrgDetails( forId id : Int64, completion : @escaping( CRMResultType.DataResponse< ZCRMOrg, APIResponse > ) -> () )
    {
    ...
    public static func getOrgDetailsFromServer( forId id : Int64, completion : @escaping( CRMResultType.DataResponse< ZCRMOrg, APIResponse > ) -> () )
    {
    ...
    public static func getModule( moduleAPIName : String, completion : @escaping( CRMResultType.DataResponse< ZCRMModule, APIResponse > ) -> () )
    {
    ...
    public static func getModules( completion : @escaping( CRMResultType.DataResponse< [ ZCRMModule ], BulkAPIResponse > ) -> () )
    {
    ...
    public static func getModules( modifiedSince : String, completion : @escaping( CRMResultType.DataResponse< [ ZCRMModule ], BulkAPIResponse > ) -> () )
    {
    ...
    public static func getCurrentUser( completion : @escaping( CRMResultType.DataResponse< ZCRMUser, APIResponse > ) -> () )
    {
    ...
    public static func getCurrentUserFromServer( completion : @escaping( CRMResultType.DataResponse< ZCRMUser, APIResponse > ) -> () )
    {
    ...
    public static func createVariables( variables : [ZCRMVariable], completion : @escaping( CRMResultType.DataResponse< [ZCRMVariable], BulkAPIResponse > ) -> () )
    {
    ...
    public static func updateVariables( variables : [ZCRMVariable], completion : @escaping( CRMResultType.DataResponse< [ZCRMVariable], BulkAPIResponse > ) -> () )
    {
    ...
    public static func getVariableGroups( completion : @escaping( CRMResultType.DataResponse< [ZCRMVariableGroup], BulkAPIResponse > ) -> () )
    {
    ...
    public static func getVariableGroup( id : Int64, completion : @escaping( CRMResultType.DataResponse< ZCRMVariableGroup, APIResponse > ) -> () )
    {
    ...
    public static func getVariableGroup( apiName : String, completion : @escaping( CRMResultType.DataResponse< ZCRMVariableGroup, APIResponse > ) -> () )
    {
    ...
    public static func getVariables( completion : @escaping( CRMResultType.DataResponse< [ZCRMVariable], BulkAPIResponse > ) -> () )
    {
    ...
    public static func getVariable( variableId : Int64, variableGroupId : Int64, completion : @escaping( CRMResultType.DataResponse< ZCRMVariable, APIResponse > ) -> () )
    {
    ...
    public static func getVariable( variableId : Int64, variableGroupAPIName : String, completion : @escaping( CRMResultType.DataResponse< ZCRMVariable, APIResponse > ) -> () )
    {
    ...
    public static func getVariable( variableAPIName : String, variableGroupId : Int64, completion : @escaping( CRMResultType.DataResponse< ZCRMVariable, APIResponse > ) -> () )
    {
    ...
    public static func getVariable( variableAPIName : String, variableGroupAPIName : String, completion : @escaping( CRMResultType.DataResponse< ZCRMVariable, APIResponse > ) -> () )
    {
    ...
    public static func deleteVariables( ids : [Int64], completion : @escaping( CRMResultType.Response< BulkAPIResponse > ) -> () )
    {
    ...
    public static func getOrgDetails( _ id : Int64, completion : @escaping ( CRMResultType.DataResponse< ZCRMOrg, APIResponse > ) -> Void )
    {
    ...
    public static func makeRequest(withURL url : URL, _ requestMethod : RequestMethod , headers : [ String : String ]?, completion : @escaping ( CRMResultType.DataURLResponse<Data, HTTPURLResponse> ) -> Void )
    {
    ...
    public static func makeRequest(withURL url : URL, _ requestMethod : RequestMethod , headers : [ String : String ]?, requestBody : [ String : Any ]?, completion : @escaping ( CRMResultType.DataURLResponse<Data, HTTPURLResponse> ) -> Void )
    {
     ...
     */
    public static func getZCRMTerritories( completion : @escaping ( CRMResultType.DataResponse< [ ZCRMTerritory ], BulkAPIResponse > ) -> ())
    {
    ...
    /**
     ...
     - Parameters:
        ...
        - completion :
            ...
            - Failure : Returns error
     */
    public static func getZCRMTerritory( byId id : Int64, completion : @escaping ( CRMResultType.DataResponse< ZCRMTerritory, APIResponse > ) -> ())
    {
