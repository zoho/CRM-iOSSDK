...
internal extension URLSession {
   func dataTask(with request : URLRequest, completion : @escaping (CRMResultType.DataURLResponse<Data, HTTPURLResponse>) -> Void) -> URLSessionDataTask {
   ...
   func uploadTask(with request : URLRequest, fromFile url : URL, completion : @escaping (CRMResultType.DataURLResponse<Data, HTTPURLResponse>) -> Void) -> URLSessionUploadTask {
   ...
   func downloadTask(with request : URLRequest, completion : @escaping (CRMResultType.DataURLResponse<Any, HTTPURLResponse>) -> Void) -> URLSessionDownloadTask {
...
{
    func getAccessToken( completion : @escaping( CRMResultType.Data< String > ) -> ()  )
}
