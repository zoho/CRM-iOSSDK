...
public class ZCRMInventoryLineItem : ZCRMEntity, Codable
{
    ...
    open func encode( to encoder : Encoder ) throws
    {
        ...
        try container.encodeIfPresent( self.discountPercentage, forKey : CodingKeys.discountPercentage )
        ...
        try container.encodeIfPresent( self.priceBookId, forKey : CodingKeys.priceBookId )
